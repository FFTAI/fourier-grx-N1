...
- 第一款手柄的指示灯为 1-4 灯常亮为 XBOX 键位
- 第二款手柄的指示灯为 Logo 蓝色常亮为 XBOX 键位

请确保手柄键位模式正确再启动程序。

![joystick_type1.jpg](/fourier-grx-N1/assets/images/joystick_type1.jpg)

![joystick_type2.jpg](/fourier-grx-N1/assets/images/joystick_type2.jpg)
...
4. 如果遇到任何机器人的异常情况，可以按下手柄的 `logo` 键，进入 `急停任务`。
   - 此时机器人会立即停止所有动作，并 `失能` 所有关节 （此时机器人会瘫软下去，请确保已做好相关保护措施，防止机器人磕坏）。
